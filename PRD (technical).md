...
1.  **Therapeutic Framework Selection Logic:**
    ...
    *   Develop distinct system prompts and/or instruction sets for Claude 3.5 Sonnet for each of the 5 specified therapeutic frameworks:
...
1.  **Outline Generation Logic:**
    ...
    *   Develop a prompt for Claude 3.5 Sonnet to generate a content outline for a short-form TikTok video.
    *   The outline should include:
        *   Hook suggestions.
        *   Main Points/Story Beats.
        *   Optional Call to Action.
        *   High-level Visual/Shot Ideas.
    *   The prompt should instruct Claude to use storytelling principles and tailor the tone based on the provided niche/style.
...
2.  **Niche/Style Customization Integration:**
    *   Ensure the outline generation prompt effectively incorporates user-provided niche and style preferences to tailor the output.
...
-   **API Latency:** Track average response times for Whisper and Claude calls.
...
*(Note: `sessionId` will be used to retrieve/store conversation context and associate with `userId` or `tempId` on the backend.)*
